...
// TestMissionSandboxComprehensiveLifecycle verifies complete mission sandbox lifecycle
// including creation, sharing across tasks, persistence, and cleanup (vc-f5c1).
//
// This test was originally named testMissionSandboxComprehensiveLifecycle (lowercase)
// which prevented it from running. Restored with correct capitalization.
